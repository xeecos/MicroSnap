...
class TMCStepper {
	public:
		...
		void 	irun(								uint8_t B);
		void 	iholdDelayMs(					uint8_t B);
		uint8_t ihold();
		uint8_t irun();
		uint8_t iholdDelayMs();
...
class TMC2208Stepper : public TMCStepper {
	public:
	    TMC2208Stepper(float RS, uint8_t addr);
		TMC2208Stepper(float RS) : TMC2208Stepper(RS, TMC2208_SLAVE_ADDR){}
...
class TMC2209Stepper : public TMC2208Stepper {
	public:
		TMC2209Stepper(float RS, uint8_t addr) : TMC2208Stepper(RS, addr) {}
